(() => {
  ...
  const HUNTING_TEMPLATE = `
    ...
    <div style="max-width:900px;margin:0 auto;">
      <h2 style="margin:0 0 10px;">Choose a Target</h2>
      <div id="targetGrid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:12px;"></div>
    ...
    TARGETS.forEach((t) => {
      ...
      card.innerHTML = `
        <div style="display:flex;gap:12px;align-items:center;">
          <img src="${t.img}" alt="${t.name}" style="width:74px;height:74px;border-radius:12px;border:2px solid #333;object-fit:cover;background:#0f0f16;">
