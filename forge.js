(() => {
  ...
  const FORGE_TEMPLATE = `
    ...
    <div class="profSection">
      ...
      <div id="forgeSmeltPanel">
        <h2 class="profSectionTitle">Choose a Bar to Smelt</h2>
        <div id="barGrid" class="profChoiceGrid" style="grid-template-columns:repeat(auto-fit,minmax(220px,1fr));"></div>
      </div>

      <div id="forgeCraftPanel" style="display:none;">
        <h2 class="profSectionTitle">Craft Items</h2>
        ...
        <div id="craftItemsView" style="display:none;">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 12px;">
            ...
            <button id="craftBackBtn" type="button" class="townBtn" style="padding:8px 12px;width:auto;min-width:0;">Back</button>
          </div>
  ...
  function renderCraftMaterials(){
    ...
    MATERIALS.forEach((material) => {
      ...
      const btn = document.createElement("button");
      btn.type = "button";
      btn.className = "profChoiceCard";
      btn.style.border = selectedMaterialId === material.id && !locked ? "2px solid #5f8cff" : "";
      ...
      label.className = "profChoiceTitle";
      ...
      subLabel.className = "profChoiceMeta";
      ...
      reqLabel.className = "profChoiceMeta";
