(() => {
  ...
  const FISHING_TEMPLATE = `
    ...
    <div class="profSection">
      <h2 class="profSectionTitle">Choose a Region</h2>
      <div id="spotGrid" class="profChoiceGrid" style="grid-template-columns:repeat(auto-fit,minmax(220px,1fr));"></div>
    </div>
  `;
    ...
    SPOTS.forEach((spot) => {
      ...
      card.innerHTML = `
        <div style="display:flex;gap:10px;align-items:center;">
          <img src="${spot.img}" alt="${spot.title}" class="profChoiceThumb" style="width:72px;height:72px;border-radius:12px;object-fit:cover;">
          <div style="flex:1;min-width:0;">
            <div class="profChoiceTitle" style="font-weight:900;font-size:16px;margin-bottom:4px;">${spot.title}</div>
            <div class="profChoiceMeta" style="font-size:12px;">Req Fishing Lv <b>${spot.req}</b></div>
